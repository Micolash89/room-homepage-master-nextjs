    ...
    <>
      <section className="flex flex-col sm:flex-row bg-white text-black sm:w-full">
        <div className="relative w-full sm:w-1/2 lg:w-3/5">
          ...
          <div className="absolute bottom-0 right-0 -translate-x-0 -translate-y-0 flex gap-4 bg-black sm:-right-[8.5rem]">
            <ButtonItemArrow
        ...
        <div className="flex flex-col gap-5 items-center px-6 py-14 sm:px-14 sm:py-20 sm:w-1/2 lg:w-2/5 sm:justify-center">
          ...
          <p className="text-balance text-grey-primary font-bold max-w-3xl">
            {description}
          </p>
...
export function ButtonItemArrow({ 
  ...
  return (
    <button className="p-6 hover:bg-gray-800 transition-colors" onClick={onClick}>
